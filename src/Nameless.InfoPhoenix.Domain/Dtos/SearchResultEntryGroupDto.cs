...
namespace Nameless.InfoPhoenix.Domain.Dtos {
    public sealed record SearchResultEntryGroupDto : IEnumerable<SearchResultEntryDto> {
        #region Public Static Read-Only Properties

        public static SearchResultEntryGroupDto Empty { get; } = new(Array.Empty<SearchResultEntryDto>());
        ...
        public SearchResultEntryGroupDto(SearchResultEntryDto[] entries) {
            _entries = entries;
        }
